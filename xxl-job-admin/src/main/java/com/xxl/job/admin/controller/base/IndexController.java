...
public class IndexController {
	...
	private List<XxlBootResourceDTO> findResourceList(HttpServletRequest request){
		...
		List<XxlBootResourceDTO> resourceDTOList = Arrays.asList(
				...
				new XxlBootResourceDTO(7, 0, I18nUtil.getString("job_operation_log_name"),1, "", "/joboperationlog", "fa-history", 4, 0, null),
				new XxlBootResourceDTO(4, 0, I18nUtil.getString("jobgroup_name"),1, Consts.ADMIN_ROLE, "/jobgroup", " fa-cloud", 5, 0,null),
				new XxlBootResourceDTO(5, 0, I18nUtil.getString("user_manage"),1, Consts.ADMIN_ROLE, "/user", "fa-users", 6, 0, null),
